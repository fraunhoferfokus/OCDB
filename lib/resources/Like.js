...
var getResource = function(ep,params,query,body,cb){
	cb(0,{resource:"media-resource-get",ep:ep,params:params,body:body,query:query});
}

var postResource = function(ep,params,query,body,cb){
	cb(0,{resource:"media-resource-post",ep:ep,params:params,body:body,query:query});
}
...
var deleteResource = function(ep,params,query,body,cb){
	cb(0,{resource:"media-resource-delete",ep:ep,params:params,body:body,query:query});
}
